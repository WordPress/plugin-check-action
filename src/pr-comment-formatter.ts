...
export class PRCommentFormatter {
	...
	private formatComment(): string {
		...
		sections.push(
			this.tableRow(['🎯 Total Issues', '❌ Errors', '⚠️ Warnings']),
		);
		sections.push(
			this.tableRow([':-------------:', ':-------:', ':---------:']),
		);
		...
		sections.push(
			'🤖 Generated by [WordPress Plugin Check Action](https://github.com/WordPress/plugin-check-action) • Learn more about [Plugin Check](https://wordpress.org/plugins/plugin-check/)',
		);
